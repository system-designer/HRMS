...
<html>
    ...
    <body>        
        <div id="xx" title="农村实用人才" class="easyui-dialog" closable="false" draggable="false" style="height:400px;width: 800px;font-size: 14px;padding:10px">
            <tr>
                <td>单位名称：</td>
            ...
            <p style="text-align: center;font-size: 16px;font-weight: bold;">农村实用人才信息</p>
