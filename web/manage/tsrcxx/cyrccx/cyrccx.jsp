<%-- 
    Document   : rcxxcx
    Created on : 2013-11-13, 19:07:52
    Author     : hp
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="<z:path/>manage/tsrcxx/cyrccx/cyrccx.js"></script>
    ...
    <body class="easyui-layout">
        <div region="north" title="查询" style="height: 165px;">
            <fieldset style="border:#D3D3D3 solid 1px;margin: 10px;height: 100px;">
                ...
                <form id="cxtj" method="post" action="<z:path/>manage/tjbb/HrmsTjbbAction.jsp?mode=DOWNLOADEXCEL&mark=6">
                    <table border="0" >
                        <tr>
                            ...
                            <td><div id="baidu_search"><input type="text" name="gzdw" id="gzdw" style="width: 200px;position:absolute;top:75px;left:785px;"></div></td>
                        </tr>
                        <tr>
                            <td style="padding-left: 30px;"><span >所属行业：</span></td>
                            <td><select id="sshy" class="easyui-combobox" name="sshy" style="width:100px;"></select></td>
                            <td style="padding-left: 30px;"><span >学&nbsp;&nbsp;&nbsp;&nbsp;位：</span></td>
                            <td><select id="xw" class="easyui-combobox" name="xw" style="width:100px;margin-top:10px"></select>
        ...
        <div region="center">
            <div id="jbxx" title="创业人才查询" toolbar="#jbxx_gridTools"></div>    
