        ...
        return this.each(function(){
            ...
            if(_171){
                ...
                _171=$.data(this,"progressbar",{
                    options:$.extend({},$.fn.progressbar.defaults,$.fn.progressbar.parseOptions(this),_16e),
                    bar:init(this)
                });
            }
    ...
    function _1d3(_1d4){
        ...
        var win=$(_1d4).panel($.extend({},_1d5.options,{
            ...
            onOpen:function(){
                ...
                /**此处修改过，修改人：张浩春*/
                //防止打开对话框时，标题栏被父窗体挡住，无法关闭和拖动
                var top = _1d5.options.top;
                var left=_1d5.options.left;
                if(top<0){
                    top=50;
                }
                if(left<0){
    ...
    $.fn.dialog=function(_1f9,_1fa){
        ...
        return this.each(function(){
            ...
            if(_1fc){
                ...
                $.data(this,"dialog",{
                    options:$.extend({},$.fn.dialog.defaults,$.fn.dialog.parseOptions(this),_1f9),
...
(function($){
    ...
    $.messager={
        ...
        alert:function(_20b,msg,icon,fn){
            var _20c="<div style=\"font-size:17px;text-align:center;\">"+msg+"</div>";
            switch(icon){
                case "error":
        ...
        return this.each(function(){
            ...
            if(_324){
                ...
                $.data(this,"menubutton",{
                    options:$.extend({},$.fn.menubutton.defaults,$.fn.menubutton.parseOptions(this),_322)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
        ...
        return this.each(function(){
            ...
            if(_32f){
                ...
                $.data(this,"splitbutton",{
                    options:$.extend({},$.fn.splitbutton.defaults,$.fn.splitbutton.parseOptions(this),_32d)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
        ...
        return this.each(function(){
            ...
            if(_346){
                ...
                _346=$.data(this,"searchbox",{
                    options:$.extend({},$.fn.searchbox.defaults,$.fn.searchbox.parseOptions(this),_344),
                    searchbox:init(this)
                });
            }
            _336(this);
...
(function($){
    function _369(_36a,_36b){
        ...
        function cb(){
            ...
            if(_36b.success){
                /**以下代码进行过修改，修改人：张浩春 2012-8-13 原代码只有一行：_36b.success(data);*/
                //jquery,easyui提交表单的ajax操作
                if(intercept){//是否进行拦截
                    if(data==npdata){//判断返回数据是否为设定的
                        alert(warnMsg);
                    }else{
                        _36b.success(data);
                    }
        ...
        return this.each(function(){
            ...
            if(_394){
                ...
                _394=$.data(this,"numberbox",{
                    options:$.extend({},$.fn.numberbox.defaults,$.fn.numberbox.parseOptions(this),_391),
                    field:init(this)
                });
                $(this).removeAttr("disabled");
                $(this).css({
        ...
        return this.each(function(){
            ...
            if(_3be){
                ...
                _3be=$.data(this,"calendar",{
                    options:$.extend({},$.fn.calendar.defaults,$.fn.calendar.parseOptions(this),_3bc)
                });
                init(this);
            }
        ...
        return this.each(function(){
            ...
            if(_3d2){
                ...
                _3d2=$.data(this,"spinner",{
                    options:$.extend({},$.fn.spinner.defaults,$.fn.spinner.parseOptions(this),_3cf),
                    spinner:init(this)
                });
                $(this).removeAttr("disabled");
            }
        ...
        return this.each(function(){
            ...
            if(_3df){
                ...
                $.data(this,"numberspinner",{
                    options:$.extend({},$.fn.numberspinner.defaults,$.fn.numberspinner.parseOptions(this),_3dc)
                });
            }
            _3d8(this);
        });
        ...
        return this.each(function(){
            ...
            if(_3f9){
                ...
                $.data(this,"timespinner",{
                    options:$.extend({},$.fn.timespinner.defaults,$.fn.timespinner.parseOptions(this),_3f6)
                });
                _3e2(this);
            }
        });
...
(function($){
    ...
    $.fn.datagrid.parseOptions=function(_55f){
        var t=$(_55f);
        return $.extend({},$.fn.panel.parseOptions(_55f),{
        ...
        return this.each(function(){
            ...
            if(_5b5){
                ...
                $.data(this,"propertygrid",{
                    options:$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_5b2)
                });
            }
            _5ac(this);
        });
    ...
    $.fn.treegrid=function(_657,_658){
        ...
        return this.each(function(){
            ...
            if(_65a){
                ...
                $.data(this,"treegrid",{
                    options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_657),
                    data:[]
                });
            }
            _5d7(this);
        ...
        return this.each(function(){
            ...
            if(_711){
                ...
                _711=$.data(this,"combobox",{
                    options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_70e)
                });
                _70c(this);
                _700(this,_6fe(this));
            }
    ...
    $.fn.combotree=function(_72b,_72c){
        ...
        return this.each(function(){
            ...
            if(_72e){
                ...
                $.data(this,"combotree",{
                    options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_72b)
                });
            }
            _71f(this);
        });
...
(function($){
        ...
        return this.each(function(){
            ...
            if(_74c){
                ...
                _74c=$.data(this,"combogrid",{
                    options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_749)
                });
            }
            _732(this);
        });
    ...
    $.fn.combogrid.parseOptions=function(_74f){
        var t=$(_74f);
        return $.extend({},$.fn.combo.parseOptions(_74f),$.fn.datagrid.parseOptions(_74f),{
    ...
    $.fn.datebox=function(_760,_761){
        ...
        return this.each(function(){
            ...
            if(_763){
                ...
                $.data(this,"datebox",{
                    options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_760)
                });
            }
            _750(this);
        });
        ...
        return this.each(function(){
            ...
            if(_77c){
                ...
                $.data(this,"datetimebox",{
                    options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_779)
                });
            }
            _766(this);
        });
        ...
        return this.each(function(){
            ...
            if(_7a9){
                ...
                _7a9=$.data(this,"slider",{
                    options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_7a7),
                    slider:init(this)
                });
                $(this).removeAttr("disabled");
            }
...
var intercept=true;//是否拦截数据
var npdata = "NOPERMISSION";//没有权限的情况下，服务器返回的标志数据是什么
var warnMsg = "对不起，你没有权限进行此项操作！";//在用户没有权限的情况下给出的警告信息
