...
<html>
    <head>
        ...
        <script type="text/javascript" src="<z:path/>manage/hbbk/hbbk.js"></script>
    ...
    <body>
        ...
        <div id="gridTools" style="padding:5px;height:auto">
            <div style="margin-bottom:5px" id="test" >
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="addHbbk()" iconCls="icon-add" plain="true">添加环保百科</a>
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="updateHbbk()" iconCls="icon-edit" plain="true">查看/修改环保百科信息</a>
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="deleteHbbk()" iconCls="icon-remove" plain="true">删除环保百科</a>
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="loadAllData()" iconCls="icon-back" plain="true">所有环保百科</a>
                <input type='text' id='ss' />
            </div>
            <div id="cxtj" style="width:120px;float:right">    
                <div name="bkmc">环保百科名称</div> 
            </div> 
        </div>
    </body>
</html>
