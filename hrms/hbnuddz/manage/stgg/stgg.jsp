...
<html>
    <head>
        ...
        <script type="text/javascript" src="<z:path/>manage/stgg/stgg.js"></script>
    ...
    <body>
        ...
        <div id="gridTools" style="padding:5px;height:auto">
            <div style="margin-bottom:5px" id="test" >
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="addGg()" iconCls="icon-add" plain="true">添加公告</a>
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="updateGg()" iconCls="icon-edit" plain="true">查看/修改公告信息</a>
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="deleteGg()" iconCls="icon-remove" plain="true">删除公告</a>
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="loadAllData()" iconCls="icon-back" plain="true">所有公告</a>
                <input type='text' id='ss' />
            </div>
            <div id="cxtj" style="width:120px;float:right">    
                <div name="xm">公告人</div>   
                <div name="ggbt">公告标题</div> 
                <div name="lbmc">公告类别</div> 
            </div> 
        </div>
    </body>
</html>
