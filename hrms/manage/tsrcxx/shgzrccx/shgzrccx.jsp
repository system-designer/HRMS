<%-- 
    Document   : shgzrccx
    Created on : 2013-11-30, 18:04:59
    Author     : hp
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="<z:path/>manage/tsrcxx/shgzrccx/shgzrccx.js"></script>
        <script type="text/javascript" src="<z:path/>manage/js/util.js"></script>
        <script type="text/javascript">
            var path = '<z:path/>'
            var input_id="gzdw";//输入框id
            var submit_id="submit";//提交按钮的id
            var urlPattern="manage/tsrcxx/shgzrc/ShgzrccxAction.jsp?mode=BAIDUINPUT";//提交路径
        </script>
    </head>
    <body class="easyui-layout">
        <div region="north" title="查询" style="height: 165px;">
            <fieldset style="border:#D3D3D3 solid 1px;margin: 10px;height: 100px;">
                ...
                <form id="cxtj" method="post" action="<z:path/>manage/tjbb/HrmsTjbbAction.jsp?mode=DOWNLOADEXCEL&mark=5">
                    <table border="0">
                        <tr>
                            ...
                            <td><select class="easyui-combobox" id="ssxt" name="ssxt" style="width:100px"></select></td>
                            <td style="padding-left: 30px"><span >单位：</span></td>
                            <td><div id="baidu_search"><input type="text" name="gzdw" id="gzdw" style="width: 200px;position:absolute;top:75px;left:752px;"></div></td>
                        </tr>
                        <tr>
                            <td style="padding-left: 30px"><span >政治面貌：</span></td>
                            <td><select class="easyui-combobox" id="zzmm" style="width:100px"></select></td>
                            ...
                            <td style="padding-left: 30px"><a href="javascript:" class="easyui-linkbutton" iconCls="icon-search" id="submit" onclick="submitForm();">查询</a></td>
                        </tr>
                    </table>   
                </form>
            </fieldset>
        ...
        <div region="center">
            <div id="jbxx" class="easyui-dategrid" title="社会工作人才查询" toolbar="#jbxx_gridTools"></div>                    
